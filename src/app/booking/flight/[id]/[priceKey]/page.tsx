'use client'
import ManagePaymnet from '@/components/payment/ManagePaymnet';
      ...
      seatsPerRow.forEach((seatLetter, index) => {
        if (seatLetter === '') {
          ...
          seatGrid.push(
            <div
              key={seatId}
              className={`flex justify-center items-center w-10 h-10 border rounded-md text-sm font-bold cursor-pointer ${isTaken
      ...
      <section id="flight-booking-detail-page" className="page-section w-full max-w-6xl bg-white shadow-lg rounded-xl p-8 mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1 bg-white p-6 rounded-lg shadow-md border border-blue-100">
            ...
            <ManagePaymnet amount={flightData?.price} />
          </div>
        </div>
